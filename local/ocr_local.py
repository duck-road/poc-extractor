...
def apply_ocr_processor_to_pdf():
    ...
    processor_id = 'fee5ed4bba14c85' # Create processor before running sample
    processor_version = 'rc' # Refer to https://cloud.google.com/document-ai/docs/manage-processor-versions for more information
    file_path = '../raw/FROMTIS/Fromtis_ContratoA_26062010.pdf'
